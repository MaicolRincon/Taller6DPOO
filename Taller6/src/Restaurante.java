...
public class Restaurante {
	...
	private void cargarIngredientes(String archivoIngredientes) throws IOException {
		...
		IngredienteRepetidoException excep = new IngredienteRepetidoException();
		excep.repetido(nombreIngredientes);
		}catch(Exception e) {
	...
	private void cargarMenu(String archivoMenu) throws IOException {
		...
		ProductoRepetidoException excep = new ProductoRepetidoException();
		excep.repetido(nombresProductos);
